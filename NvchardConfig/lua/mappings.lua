...
map("n", "<leader>h", "<cmd>noh<CR>", { desc = "general clear highlights" })
...
-- dashboard
map("n", "<leader>a", "<cmd>Nvdash <CR>", { desc = "CMD enter command mode" })

-- config
map("n", "<leader>;", "<cmd>edit ~/.config/nvim/init.lua<CR>", { desc = "Edit config" })
